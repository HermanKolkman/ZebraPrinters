...
namespace CSharpContactlessSmartCardSample
{
    class SampleCodeMag
    {
        MyNewBadgeMaker.ZBRPrinter _thePrinterSDK = null;
        #region Constructor
        ...
        {
            _thePrinterSDK = new MyNewBadgeMaker.ZBRPrinter();
        }
        ...
        {
            MyNewBadgeMaker.ZBRPrinter prn = null; 

            string version = "";

            try
            {
                prn = new MyNewBadgeMaker.ZBRPrinter();
        ...
        ***************************************************************************************************/
        public void PerformMagneticEncodeJob(string deviceName, ref string errMsg)
        {
            string track1 = "1";
            string track2 = errMsg;
            string track3 = "3";
