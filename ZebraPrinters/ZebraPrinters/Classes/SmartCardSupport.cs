                                         ...
                                         out string errMsg)
        {
            ...
            try
            {
                ...
                while (readersList[indx] != 0)
                {
                    ...
                    if (readerName.Contains("OEM"))// || readerName.Contains("ACR38U") || readerName.Contains("ACS") || readerName.Contains("SDI010 Smart Card Reader"))
                        contactReader = readerName;

                    else if (readerName.Contains("Elatec SmartCard Reader 0 Slot 0"))
                        contactlessReader = "Elatec SmartCard Reader 0 Slot 0";
